  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-800 transition-colors">
      <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
        <Link
          to="/"
          className="text-2xl font-extrabold bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent"
        >
          EventHub
        </Link>
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          {!user && (
            <>
              ...
              <Link
                to="/register"
                className="bg-gradient-to-r from-purple-600 to-pink-500 text-white px-4 py-2 rounded-xl text-sm font-semibold hover:opacity-90 transition"
              >
                Register
              </Link>
            </>
        ...
        {menuOpen && (
          ...
          >
            <Link
              ...
              className="py-2 text-gray-700 dark:text-gray-300 font-medium"
            >
              Events
            </Link>
            <Link
            ...
            {user ? (
              <>
                ...
                <Link
                  to="/create-event"
                  onClick={() => setMenuOpen(false)}
                  className="py-2 text-purple-600 font-semibold"
                >
                  + Create Event
                </Link>
                <button
                  onClick={handleLogout}
                  className="py-2 text-red-500 text-left font-medium"
                >
                  Logout
                </button>
              </>
