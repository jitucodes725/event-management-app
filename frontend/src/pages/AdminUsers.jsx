    ...
    <div className="min-h-screen bg-gray-950 text-white px-4 md:px-8 py-8">
      <div className="max-w-5xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          ...
          <Link
            to="/admin/dashboard"
            className="px-4 py-2 rounded-xl bg-gray-800 text-sm text-gray-300 hover:bg-gray-700 transition"
          >
            ← Dashboard
          </Link>
        </div>
              ...
              >
                ...
                {user.profilePic ? (
                  <img
                    ...
                    alt={user.name}
                    className="w-12 h-12 rounded-full object-cover border-2 border-purple-700 flex-shrink-0"
                  />
                ) : (
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {user.phoneNumber && (
                    <p className="text-gray-400 text-sm flex items-center gap-1">
                      <FiPhone size={12} /> {user.phoneNumber}
                    </p>
                  )}
                  {user.bio && (
                ...
                {/* Joined date */}
                <div className="text-gray-500 text-xs text-right hidden md:block flex-shrink-0">
                  <p>Joined</p>
